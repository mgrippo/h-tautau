...
namespace ntuple {
    ...
    public:
        ...
        {
            if(!tauIds.size()) {
                std::cout << "Here 2 - legId: " << leg_id <<  std::endl;
                ...
                std::cout << "keys: " << keys.size() << ", values: " << values.size() <<  std::endl;
            ...
            std::cout << "has_result: " << has_result << std::endl;
            if(has_result)
