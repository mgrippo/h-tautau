...
std::vector<BaseTupleProducer::TauCandidate> TupleProducer_tauTau_ZB::CollectSignalTaus()
{
    using namespace std::placeholders;
    const auto base_selector = std::bind(&TupleProducer_tauTau_ZB::SelectSignalTau, this, _1, _2);
    return CollectObjects("SignalTaus", base_selector, taus);
}

void TupleProducer_tauTau_ZB::SelectSignalTau(const TauCandidate& tau, Cutter& cut) const
{
